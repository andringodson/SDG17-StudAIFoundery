    ...
    <DashboardShell role="investor" username={user.username} emailVerified={user.is_email_verified} profileCompletePct={user.profile_completed_pct}>
      ...
      <div className="mt-8 rounded-xl border border-line bg-surface-1/60 p-5">
        ...
        <p className="mt-1 text-sm text-text-2">
          Browse registered companies and government agencies by sector, ranked by how closely their sector overlaps
          yours, and message them directly. A live portfolio feed still isn't connected to any data source, so this
          dashboard won't invent numbers for that — but discovery and messaging are real. What else you can use now:
          the Global Partnership Map (real regional data), the Finance Impact Simulator, and the Partnership
          Builder's scoring model.
        </p>
