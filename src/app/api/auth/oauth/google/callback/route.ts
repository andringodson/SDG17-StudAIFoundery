...
import { isGoogleConfigured, exchangeGoogleCode, findOrCreateOAuthUser } from '@/lib/oauth';
...
export async function GET(req: NextRequest) {
  ...
  if (!isGoogleConfigured()) return NextResponse.redirect(`${appOrigin}/auth/login?oauthError=not_configured`);
